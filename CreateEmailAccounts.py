...
def getData():
    prefix = "@yandex.com"
    firstnames = json.load(open("Emails/firstnames.json", "r"))
    lastnames = json.load(open("Emails/lastnames.json", "r"))
...
driver = webdriver.Chrome("Emails/chromedriver.exe", options=options)
